...
<head>
    ...
    <title>Kontakt | BILD-IT e-Shop</title>
	...
	<header id="header"><!--header-->
	 ...
	 <div id="contact-page" class="container">
    	<div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">    			   			
					<h2 class="title text-center">Kontaktiraj <strong>nas</strong></h2>    			    				    				
				</div>			 		
			</div>    	
    		<div class="row">  	
	    		<div class="col-sm-8">
	    			<div class="contact-form">
	    				<h2 class="title text-center">Javi nam se</h2>
				    	...
				    	<form id="main-contact-form" class="contact-form row" name="contact-form" method="post">
				            ...
				            <div class="form-group col-md-12">
				                <textarea name="message" id="message" required="required" class="form-control" rows="8" placeholder="Vaša poruka"></textarea>
				            </div>                        
				            <div class="form-group col-md-12">
	    		...
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				<h2 class="title text-center">Navrati do nas</h2>
	    				<address>
	    					<p>BILD-IT</p>
							<p>Slavinovići b.b. / 75000 Tuzla</p>
							<p>Bosna i Hercegovina</p>
							<p>Mobile: +387 61 66 44 31</p>
							<p>Fax: +387 35 22 11 63</p>
							<p>Email: contact@bildbosnia.org</p>
	    				</address>
	    				<div class="social-networks">
	    					<h2 class="title text-center">Socijalne mreže</h2>
							<ul>
								<li>

...
<head>
    ...
    <title>Home | BILD-IT e-Shop</title>
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									<h1><span>Galaxy S7</span> by Samsung</h1>
									<h2>Brži. Bolji. Jači.</h2>
									<p>Novi Samsung Galaxy S7 predstavlja vrhunac tehnološkog napretka kompanije Samsung. Njihov flagship telefon je jedan od najjačih telefona na tržištu - s razlogom. </p>
									<button type="button" class="btn btn-default get">Kupiti</button>
								</div>
								<div class="col-sm-6">
									<img src="images/home/s7.jpg" class="mobitel img-responsive" alt="" />
									<img src="images/home/pricingS7.png"  class="pricing" alt="" />
								</div>
							</div>
							<div class="item">
								<div class="col-sm-6">
									<h1><span>G4</span> by LG</h1>
									<h2>Osjeti moć</h2>
									<p>LG nam donosi na tržište svoj najnoviji flagship telefon u obliku G4 koji je tu da parira Samsungu. Da li može uspjeti u svom podhvatu? </p>
									<button type="button" class="btn btn-default get">Kupiti</button>
								</div>
								<div class="col-sm-6">
									<img src="images/home/g4.jpg" class="mobitel img-responsive" alt="" />
									<img src="images/home/pricingLGG4.png"  class="pricing" alt="" />
								</div>
							</div>
							
							<div class="item">
								<div class="col-sm-6">
									<h1><span>Lumia 950 XL</span> by Microsoft</h1>
									<h2>Sila nebeska</h2>
									<p>Microsoft nas je iznenadio ove godine svojim flagship telefonom u obliku Lumie 950 XL. Brža, jača i bolja od svih svojih prethodnika, nova Lumia je tu da pokaže da Microsoft može više.</p>
									<button type="button" class="btn btn-default get">Kupiti</button>
								</div>
								<div class="col-sm-6">
									<img src="images/home/lumia.jpg" class="mobile img-responsive" alt="" />
									<img src="images/home/pricingLumia.png" class="pricing" alt="" />
								</div>
							</div>
			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!-- izdvojeni itemi -->
						<h2 class="title text-center">Izdvojeni artikli</h2>
						<div class="col-sm-4">
